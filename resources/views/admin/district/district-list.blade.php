            ...
            <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div>
                    ...
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('admin/district')}}">Districts</a></li>
                    ...
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            ...
                            <div class="d-flex">
                                ...
                                <a href="{{url('admin/createdistrict')}}"
                                    class="btn btn-sm btn-primary btn-wave waves-light"><i
                                        class="ri-add-line fw-medium align-middle me-1"></i> Create District</a>
                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr class="District-list">
                                            ...
                                            <th class="bg-yellow-themed text-fixed-white " scope="col">Province
                                            </th>
                                            <th class="bg-yellow-themed text-fixed-white " scope="col">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody id="dataTable">
                                        @foreach($district as $index => $dis)
                                        <tr class="District-list">
                                            <td>{{ $index + 1 }}</td>
                                            <td class="data-name">{{ $dis->district_name }}</td>
                                            <td class="province-name">{{ $dis->province->province_name }}</td>
                                            <td>
                                                <a href="{{ route('editdistrict', $dis->id) }}"
                                                    class="btn btn-primary-light btn-icon btn-sm">
                                                    <i class="ri-edit-line"></i>
                                                </a>
                                                <form action="{{ route('district.destroy', $dis->id) }}" method="POST"
