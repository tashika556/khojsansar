                    ...
                    <div class="card custom-card">
                        ...
                        <form action="{{ route('storedistrict') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">District Name <span class="text-danger">*</span> :</label>
                                        <input type="text" name="district_name" class="form-control" id="input-label"
                                            placeholder="Enter District Name">
                                    </div>
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Select Province <span class="text-danger">*</span> :</label>
