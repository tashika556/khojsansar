...
@section('page_title','Add Site Setting')
@push("after-styles")
                    ...
                    <div class="">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('admin/sitesetting')}}">sitesettings</a></li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <form action="{{ route('storesitesetting') }}" method="POST" enctype="multipart/form-data">
                            @csrf 
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Site Title<span class="text-danger">*</span> :</label>
                                        <input type="text" name="site_title" class="form-control" id="input-label"
                                            placeholder="Enter Site Title">
                                    </div>
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Caption<span class="text-danger">*</span> :</label>
                                        <input type="text" name="caption" class="form-control" id="input-label"
                                            placeholder="Enter Caption">
                                    </div>
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Logo<span class="text-danger">*</span> :</label>
                                     <input type="file" name="logo" class="form-control" id="input-label">
                                  
                                    </div>
                                    <div class="col-12">
                                        <label for="input-label" class="form-label">Slider Images (Home Page)<span class="text-danger">*</span> :</label>
                                        <input type="file" id="input-label" name="slider_images[]" accept="image/*" multiple>
