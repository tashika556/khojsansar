...
@section('page_title','View Site Setting')
@push("after-styles")
            ...
            <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div>
                    ...
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('admin/sitesetting')}}">Site Settings</a></li>
                    ...
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            ...
                            <div class="d-flex">
                                ...
                                <a href="{{ url('admin/editsitesetting', $sitesetting->id) }}"
                                    class="btn btn-sm btn-primary btn-wave waves-light">
                                    <i class="ri-edit-line fw-medium align-middle me-1"></i> Edit Site Settings
                                </a>
