...
@section('page_title','Add Municipality')
@push("after-styles")
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <form action="{{ route('storemunicipality') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Municipality Name <span class="text-danger">*</span> :</label>
                                        <input type="text" name="municipality_name" class="form-control" id="input-label"
                                            placeholder="Enter Municipality Name">
                                    </div>
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Short Name :</label>
                                        <input type="text" name="municipality_shortname" class="form-control" id="input-label"
                                            placeholder="Enter Municipality Short Name">
                                    </div>
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Select District <span class="text-danger">*</span> :</label>
