...
@section('page_title','Edit Municipality')
@push("after-styles")
                    ...
                    <div class="">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('admin/municipality')}}">Municipalities</a></li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <form action="{{ route('updatemunicipality', $municipality->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Municipality Name <span
                                                class="text-danger">*</span> :</label>
                                        <input type="text" name="municipality_name" value="{{ $municipality->municipality_name }}"
                                            class="form-control select-data" id="input-label"
                                            placeholder="Enter Municipality Name">
                                    </div>
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Short Name :</label>
                                        <input type="text" name="municipality_shortname" class="form-control" value="{{ $municipality->municipality_shortname }}" id="input-label"
                                            placeholder="Enter Municipality Short Name">
                                    </div>
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Select District <span
                                                class="text-danger">*</span> :</label>

                                        <select name="district_id" class="form-control select-data">
                                            <option value="{{ $municipality->district_id}}">
                                                {{ $municipality->district->district_name}}</option>
                                            <option value="" class="bg-yellow-themed text-fixed-white">Select district *
                                            </option>
