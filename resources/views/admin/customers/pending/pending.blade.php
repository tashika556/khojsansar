...
@section('page_title','View Pending Customers')
@push("after-styles")
            ...
            <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div>
                    ...
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('admin/pendingcustomer')}}">Pending Customers</a>
                        </li>
                                ...
                                <table class="table text-nowrap">
                                    ...
                                    <tbody id="dataTable">
                                        ...
                                        <tr class="Customers-list">
                                            ...
                                            <td>
                                                <a href="{{ route('viewpendingcustomers', $cus->id) }}"
                                                ...
                                                <div class="dropdown d-inline">
                                                    <button
                                                        ...
                                                        type="button" id="dropdownMenuButton{{ $cus->id }}"
                                                        data-bs-toggle="dropdown" aria-expanded="false">
                                                        <i class="ri-more-2-line"></i>
                                                    </button>
                                                    <ul class="dropdown-menu dropdown-status"
                                                        aria-labelledby="dropdownMenuButton{{ $cus->id }}">
                                                        <li>
                                                            <form
                                                                action="{{ route('pendingcustomer.verify', $cus->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                <button type="submit"
                                                        ...
                                                        <li>
                                                            <button class="dropdown-item" data-bs-toggle="modal"
                                                                data-bs-target="#rejectModal{{ $cus->id }}">
                                                                Reject
                                                            </button>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div class="modal fade" id="rejectModal{{ $cus->id }}" tabindex="-1"
                                                    aria-labelledby="rejectModalLabel{{ $cus->id }}" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="rejectModalLabel{{ $cus->id }}">Reject Reason
                                                                </h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <form
                                                                action="{{ route('pendingcustomer.reject', $cus->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                <div class="modal-body">
                                                                    <div class="mb-3">
                                                                        <label for="rejectionReason{{ $cus->id }}"
                                                                            class="form-label">Reason for
                                                                            Rejection</label>
                                                                        <textarea class="form-control"
                                                                            id="rejectionReason{{ $cus->id }}"
