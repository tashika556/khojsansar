...
@section('page_title','View Rejected Customers')
@push("after-styles")
            ...
            <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div>
                    ...
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('admin/rejectedcustomer')}}">Rejected Customers</a>
                        </li>
                                ...
                                <table class="table text-nowrap">
                                    ...
                                    <tbody id="dataTable">
                                        ...
                                        <tr class="Customers-list">
                                            ...
                                            <td>
                                                <a href="{{ route('viewrejectedcustomers', $cus->id) }}"
