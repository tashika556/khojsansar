...
@section('page_title','View Not Approved Business')
@push("after-styles")
            ...
            <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div>
                    ...
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('admin/notapprovedbusiness')}}">Not Approved Business</a>
                        </li>
                                ...
                                <table class="table text-nowrap">
                                    ...
                                    <tbody id="dataTable">
                                        ...
                                        <tr class="Business-list">
                                            ...
                                            <td>
                                                <a href="{{ route('viewnotapprovedbusiness', $bus->id) }}"
