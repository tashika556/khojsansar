...
@section('page_title','View Verified Business')
@push("after-styles")
            ...
            <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div>
                    ...
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('admin/verifiedbusiness')}}">Verified Business</a>
                        </li>
                                    ...
                                    <tbody id="dataTable">
                                        ...
                                        <tr class="Business-list">
                                            ...
                                            <td class="muni-name">{{ $bus->customershow->first_name}}
                                                {{ $bus->customershow->middle_name}} {{ $bus->customershow->last_name}}
                                            </td>
                                            <td>

                                                {{ $bus->payment->payment_confirmation ? 'Yes' : 'No' }}
                                            </td>
                                            <td>
                                                <a href="{{ route('viewverifiedbusiness', $bus->id) }}" class="btn btn-info btn-icon btn-sm">
