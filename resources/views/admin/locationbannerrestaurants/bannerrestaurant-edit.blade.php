...
@section('page_title','Edit Banner for Restaurant Location')
@push("after-styles")
                    ...
                    <div class="">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('admin/locationrestaurant')}}">Banner for Restaurant Location</a></li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <form action="{{ route('updatelocationrestaurant', $bannerbyrestaurant->id) }}"
                            ...
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-6">
                                        <label for="input-label" class="form-label">District <span
                                                class="text-danger">*</span> :</label>
                                        <select name="district_id" id="input-label" class="form-control">
                                        <option value="$bannerbyrestaurant->district_id)">{{$bannerbyrestaurant->district->district_name}}</option>
                                            <option value="" style="background:#a11e1c;color:white;">Select District</option>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="container__img-holder">
                                            <img src="{{ asset('uploads/bannerbyrestaurant/' . $bannerbyrestaurant->cover_image) }}"
                            ...
                            <div class="card-footer">
                                <button class="btn btn-primary-light btn-wave ms-auto float-end mb-2">Edit
                                    bannerbyrestaurants</button>
                            </div>
                        </form>
                    </div>
                </div>
