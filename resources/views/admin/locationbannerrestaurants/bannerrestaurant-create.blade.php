...
@section('page_title','Add Banner for Restaurant Location')
@push("after-styles")
                    ...
                    <div class="">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('admin/locationrestaurant')}}">Banner for
                                        Restaurant Location</a></li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <form action="{{ route('storelocationrestaurant') }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row gy-3">
                            ...
                            <div class="card-footer">
                                <button class="btn btn-primary-light btn-wave ms-auto float-end mb-4">Create Banner for
