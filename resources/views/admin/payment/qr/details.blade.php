...
@section('page_title','Edit QR Payment Details')
@push("after-styles")
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <form action="{{ route('payment.update', $paymentMethod->id) }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Bank Name <span
                                                class="text-danger">*</span> :</label>
                                        <input type="text" name="accountholder_bank_name" class="form-control"
                                            value="{{ $paymentMethod->accountholder_bank_name }}">

                                    </div>
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Account Holder Name <span
                                                class="text-danger">*</span> :</label>
                                        <input type="text" name="accountholder_name" class="form-control"
                                            value="{{ $paymentMethod->accountholder_name }}">

                                    </div>
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Branch <span
                                                class="text-danger">*</span> :</label>
                                        <input type="text" name="accountholder_branch" class="form-control"
                                            value="{{ $paymentMethod->accountholder_branch }}">

                                    </div>
                                    <div class="col-xl-6">
                                        <label for="input-label" class="form-label">Account Number <span
                                                class="text-danger">*</span> :</label>
                                        <input type="text" name="accountholder_number" class="form-control"
                                            value="{{ $paymentMethod->accountholder_number }}">

                                    </div>
                                    <div class="col-xl-6">
                                        <label for="input-label" class="form-label">Upload QR Photo <span
                                                class="text-danger">*</span> :</label>
                            ...
                            <div class="card-footer">
                                <button class="btn btn-primary-light btn-wave ms-auto float-end mb-4">Edit
