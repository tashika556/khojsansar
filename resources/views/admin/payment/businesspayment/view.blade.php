...
@section('page_title','View Payment done by Business Details')
@push("after-styles")
                    ...
                    <div class="">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('admin/businesspayment')}}">View Payment done by
                                        Business</a></li>
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-xl-4 col-md-6 col-12">
                                    ...
                                    <div class="input-view-box">
                                        <p>{{ $payment->businesses->customershow->authorizeshow->authorize_name }}</p>
                                    </div>
                                ...
                                <div class="col-xl-4 col-md-6 col-12">
                                    ...
                                    <div class="input-view-box">
                                        <p>{{ $payment->businesses->customershow->business }}</p>
                                    </div>
                                ...
                                <div class="col-xl-4 col-md-6 col-12">
                                    ...
                                    <div class="input-view-box">
                                        <p>{{ $payment->businesses->customershow->categoryshow->category_name  }}</p>
                                    </div>
                                ...
                                <div class="col-xl-4 col-md-6 col-12">
                                    ...
                                    <div class="input-view-box">
                                        <p>{{ $payment->businesses->customershow->first_name  }}
                                            {{ $payment->businesses->customershow->middle_name  }}
                                            {{ $payment->businesses->customershow->last_name  }}</p>
                                    </div>
                                ...
                                <div class="col-xl-3 col-md-6 col-12">
                                    ...
                                    <div class="input-view-box">
                                        <p> {{ $payment->payment_confirmation ? 'Yes' : 'No' }}</p>
                                    </div>

                                </div>
                                <div class="col-xl-3 col-md-6 col-12">
                                    <label for="input-label" class="form-label">Admin Confirmation? :</label>
                                    <div class="input-view-box">
                                        <p> {{ $payment->admin_payment_confirmation ? 'Yes' : 'No' }}</p>
                                    </div>
