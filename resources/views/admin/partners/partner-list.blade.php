...
@section('page_title','View Partner')
@push("after-styles")
                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            ...
                            <div class="d-flex">
                            <a href="{{url('admin/createpartner')}}"
                                    class="btn btn-sm btn-primary btn-wave waves-light"><i
                                        class="ri-edit-line fw-medium align-middle me-1"></i> Create Partner</a>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <tbody id="dataTable">
                                        @foreach($partner as $index => $cat)
                                        <tr class="partner-list">
                                            <td>{{ $index + 1 }}</td>
                                            <td class="data-name">{{ $cat->title }}</td>
                                            <td>
                                                <a href="{{ route('editpartner', $cat->id) }}"
                                                    class="btn btn-primary-light btn-icon btn-sm">
                                                    <i class="ri-edit-line"></i>
                                                </a>
                                                <form action="{{ route('partner.destroy', $cat->id) }}" method="POST"
