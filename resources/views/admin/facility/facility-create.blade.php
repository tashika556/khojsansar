                            ...
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-4">
                                        ...
                                        <input type="text" name="facility_name" class="form-control" id="input-label"
                                    ...
                                    <div class="col-xl-4">
                                        ...
                                        <input type="file" name="facility_logo" class="form-control"
                                            >
                                            <span class="text-themed-yellow">Hint: You can download logo from this link : <a href="https://www.iconpacks.net/" class="text-danger" target="_blank">
                                                 https://www.iconpacks.net/ </a>or any other domains and remember to put logo color : #eb8018 and
