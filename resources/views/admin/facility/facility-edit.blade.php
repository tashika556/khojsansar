                    ...
                    <div class="">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('admin/facility')}}">Facilities</a></li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <form action="{{ route('update', $facility->id) }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Facility Name  <span class="text-danger">*</span> :</label>
                                        <input type="text" name="facility_name" value="{{ $facility->facility_name }}"
                                            class="form-control" id="input-label" placeholder="Enter Facility Name">
                                    </div>
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Facility Logo <span class="text-danger">*</span> :</label>
                                        <input type="file" name="facility_logo" class="form-control">
                                        <span class="text-themed-yellow">Hint: You can download logo from this link : <a
                                                href="https://www.iconpacks.net/" class="text-danger" target="_blank">
                                                https://www.iconpacks.net/ </a>or any other domains and remember to put
                                            logo color : #eb8018 and
                                            logo's width,height : 24px;</span>
