...
@section('page_title','Edit Khojsansar Services')
@push("after-styles")
                    ...
                    <div class="">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('admin/khojsansarservice')}}">Khojsansar
                                        Services</a></li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <form action="{{ route('updatekhojsansarservice', $khojsansarservice->id) }}"
                            ...
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-6">
                                        <label for="input-label" class="form-label">Service Name <span
                                                class="text-danger">*</span> :</label>
                                        <input type="text" name="title" class="form-control" id="input-label"
                                            placeholder="Enter Service Name" value="{{ $khojsansarservice->title }}">
                                    </div>
                                    <div class="col-xl-6">
                                        ...
                                        <div class="container__img-holder">
                                            <img src="{{ asset('uploads/khojsansarservice/' . $khojsansarservice->banner) }}"
                                                alt="banner" width="200" style="margin-top:10px;">
                                        </div>
                                    </div>
                                    <div class="col-8">
                                        <label for="input-label" class="form-label">Details<span
                                                class="text-danger">*</span> :</label>
                                        <textarea name="details" class="form-control" id="input-label" rows="6"
                                            id="">{{ $khojsansarservice->details }}</textarea>

                                    </div>
                                    <div class="col-4">
                                        <label for="input-label" class="form-label">Icon<span
                                                class="text-danger">*</span> : </label><span class="text-danger"> Note:-
                                            Remember to put icon size , width and height =40px with color: white and in
                                            png form</span>
                                        <input type="file" name="icon" class="form-control" id="input-label">
                                        <img src="{{ asset('uploads/khojsansarservice/icon/' . $khojsansarservice->icon) }}"
                                            alt="icon" width="40"
                                            style="background:black; margin-top:10px; padding:2px;">
                                    </div>
                                </div>
                            </div>
