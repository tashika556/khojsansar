...
@section('page_title','Add Khojsansar Services')
@push("after-styles")
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <form action="{{ route('storekhojsansarservice') }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            <div class="card-body"> 
                                <div class="row gy-3">
                                    ...
                                    <div class="col-4">
                                        <label for="input-label" class="form-label">Icon<span
                                                ...
                                                class="text-danger"> Note:- Remember to put icon size , width and height =40px with color: white and in png form</span>
