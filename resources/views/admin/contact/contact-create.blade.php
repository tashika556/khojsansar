                            ...
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-3 col-md-6 col-12">
                                        <label for="input-label" class="form-label">Address One<span class="text-danger">*</span> :</label>
                                        <input type="text" name="address_one" class="form-control" id="input-label"
                                            placeholder="Enter Address One">
                                    </div>
                                    <div class="col-xl-3 col-md-6 col-12">
                                        <label for="input-label" class="form-label">Address Two :</label>
                                        <input type="text" name="address_two" class="form-control" id="input-label"
                                            placeholder="Enter Address Two">
                                    </div>
                                    <div class="col-xl-3 col-md-6 col-12">
                                        <label for="input-label" class="form-label">Email One<span class="text-danger">*</span> :</label>
                                        <input type="email" name="email_one" class="form-control" id="input-label"
                                            placeholder="Enter Email One">
                                    </div>
                                    <div class="col-xl-3 col-md-6 col-12">
                                        <label for="input-label" class="form-label">Email Two :</label>
                                        <input type="email" name="email_two" class="form-control" id="input-label"
                                            placeholder="Enter Email Two">
                                    </div>
                                    <div class="col-xl-3 col-md-6 col-12">
                                        <label for="input-label" class="form-label">Phone One<span class="text-danger">*</span> :</label>
                                        <input type="text" name="phone_one" class="form-control" id="input-label"
                                            placeholder="Enter Phone One">
                                    </div>
                                    <div class="col-xl-3 col-md-6 col-12">
                                        <label for="input-label" class="form-label">Phone Two :</label>
                                        <input type="text" name="phone_two" class="form-control" id="input-label"
                                            placeholder="Enter Phone Two">
                                    </div>
                                    <div class="col-xl-3 col-md-6 col-12">
                                        <label for="input-label" class="form-label">Facebook URL :</label>
                                        <input type="text" name="facebook_url" class="form-control" id="input-label"
                                            placeholder="Enter Facebook URL">
                                    </div>
                                    <div class="col-xl-3 col-md-6 col-12">
                                        <label for="input-label" class="form-label">Twitter URL :</label>
                                        <input type="text" name="twitter_url" class="form-control" id="input-label"
                                            placeholder="Enter Twitter URL">
                                    </div>
                                    <div class="col-xl-3 col-md-6 col-12">
                                        <label for="input-label" class="form-label">Instagram URL :</label>
                                        <input type="text" name="instagram_url" class="form-control" id="input-label"
                                            placeholder="Enter Instagram URL">
                                    </div>
                                    <div class="col-xl-3 col-md-6 col-12">
                                        <label for="input-label" class="form-label">Youtube URL :</label>
                                        <input type="text" name="youtube_url" class="form-control" id="input-label"
                                            placeholder="Enter Youtube URL">
                                    </div>
                                    <div class="col-xl-3 col-md-6 col-12">
                                        <label for="input-label" class="form-label">Opening Hours :</label>
                                        <input type="text" name="opening_hours" class="form-control" id="input-label"
                                            placeholder="Enter Opening Hours">
                                    </div>
                                    <div class="col-xl-3 col-md-6 col-12">
                                        <label for="input-label" class="form-label">Banner<span class="text-danger">*</span> :</label>
                                     <input type="file" name="banner" class="form-control" id="input-label">
                                  
                                    </div>
                                    <div class="col-12">
                                        <label for="input-label" class="form-label">Map URL<span class="text-danger">*</span> :</label>
                                     <input type="text" name="map_url" class="form-control" id="input-label">
