...
@section('page_title','View Authorize')
@push("after-styles")
            ...
            <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div>
                    ...
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('admin/authorize')}}">Authorizes</a></li>
                    ...
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            ...
                            <div class="d-flex">
                                ...
                                <a href="{{url('admin/createauthorize')}}"
                                    class="btn btn-sm btn-primary btn-wave waves-light"><i
                                        class="ri-add-line fw-medium align-middle me-1"></i> Create Authorize</a>
                            </div>
                        </div>
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr class="Authorize-list">
                                            <th class="bg-yellow-themed text-fixed-white " scope="col">S.No.</th>
                                            <th class="bg-yellow-themed text-fixed-white " scope="col">Authorize Name
                                            </th>
                                    ...
                                    <tbody id="dataTable">
                                        @foreach($authorize as $index => $aut)
                                        <tr class="Authorize-list">
                                            <td>{{ $index + 1 }}</td>
                                            <td class="data-name">{{ $aut->authorize_name }}</td>
                                            <td>
                                                <a href="{{ route('editauthorize', $aut->id) }}"
                                                    class="btn btn-primary-light btn-icon btn-sm">
                                                    <i class="ri-edit-line"></i>
                                                </a>
                                                <form action="{{ route('authorize.destroy', $aut->id) }}" method="POST"
