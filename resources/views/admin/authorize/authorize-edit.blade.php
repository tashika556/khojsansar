...
@section('page_title','Edit Authorize')
@push("after-styles")
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <form action="{{ route('updateauthorize', $authorize->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Authorize Name <span class="text-danger">*</span> :</label>
                                        <input type="text" name="authorize_name" value="{{ $authorize->authorize_name }}" class="form-control" id="input-label"
                                            placeholder="Enter Authorize Name">
                                    </div>
                                </div>
                            </div>
