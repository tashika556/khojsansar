                            ...
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" name="name" class="form-control" id="input-label"
                                            placeholder="Enter Full Name">
                                    </div>
                                    <div class="col-xl-6">
                                        <label for="input-label" class="form-label">Address <span class="text-danger">*</span> :</label>
                                        <input type="text" name="address" class="form-control" id="input-label"
                                            placeholder="Enter Address">
                                    </div>
                                    <div class="col-12">
                                        <label for="input-label" class="form-label">Message<span class="text-danger">*</span> :</label>
                                        <textarea name="message" class="form-control"  id="input-label" rows="6" id=""></textarea>
