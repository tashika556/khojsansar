            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="{{url('admin/pendingcustomer')}}"
                                class="text-fixed-white side-menu__item">Pending</a>
                        </li>
                        <li class="slide">
                            <a href="{{url('admin/verifiedcustomer')}}"
                                class="text-fixed-white side-menu__item">Verified</a>
                        </li>
                        <li class="slide">
                            <a href="{{url('admin/rejectedcustomer')}}"
                                class="text-fixed-white side-menu__item">Rejected</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="text-fixed-white side-menu__item">QR
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide">
                                    <a href="{{ url('admin/payment/' . $paymentMethod->id) }}"
                                        class="text-fixed-white side-menu__item">
                                        Bank Details
                                    </a>
                                </li>
                                @endforeach
                                @else
                                <li class="slide"> <a href="{{ url('admin/payment/' . $paymentMethod->id) }}"
                                        class="text-fixed-white side-menu__item">
                                        Bank Details
                                    </a></li>
                                @endif
