            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <form action="{{ route('updateprovince', $province->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Province Name <span class="text-danger">*</span> :</label>
                                        <input type="text" name="province_name" value="{{ $province->province_name }}" class="form-control" id="input-label"
