                    ...
                    <div class="card custom-card">
                        ...
                        @method('PUT')
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-4">
                                        <label for="input-label" class="form-label">Category Name <span class="text-danger">*</span> :</label>
                                        <input type="text" name="category_name" value="{{ $category->category_name }}" class="form-control" id="input-label"
