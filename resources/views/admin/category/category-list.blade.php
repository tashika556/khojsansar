                    ...
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            ...
                            <div class="d-flex">
                                ...
                                <a href="{{url('admin/createcategory')}}"
                                    class="btn btn-sm btn-primary btn-wave waves-light"><i
                                        class="ri-add-line fw-medium align-middle me-1"></i> Create Category</a>
                            </div>
                        </div>
                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr class="category-list">
                                            ...
                                            <th class="bg-yellow-themed text-fixed-white " scope="col">Category Name
                                            </th>
                                    ...
                                    <tbody id="dataTable">
                                        ...
                                        <tr class="category-list">
                                            <td>{{ $index + 1 }}</td>
                                            <td class="data-name">{{ $cat->category_name }}</td>
                                            <td>
