                                ...
                                <div class="row gy-3">
                                    <div class="col-xl-4">
                                        ...
                                        <input type="text" name="service_name" value="{{ $service->service_name }}"
                                            class="form-control" id="input-label" placeholder="Enter service Name">
                                    </div>
                                    <div class="col-xl-4">
                                        ...
                                        <span class="text-themed-red">Hint: You can download logo from this link : <a
                                            ...
                                            logo color : #b01918 and
                                            logo's width,height : 45px;</span>
                                       
                                    </div>
                                    <div class="col-xl-4">
                                        <div class="img-service">
                                            <img src="{{asset('/uploads/iconsservice/'.$service->service_logo)}}"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
