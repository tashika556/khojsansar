...
<link rel="stylesheet" href="{{ asset('admin/libs/%40tarekraaser/autocomplete.js/css/autoComplete.css') }}">
                    ...
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            ...
                            <div class="d-flex">
                                ...
                                <a href="{{url('admin/createservice')}}"
                                    class="btn btn-sm btn-primary btn-wave waves-light"><i
                                        class="ri-add-line fw-medium align-middle me-1"></i> Create Service</a>
                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr class="category-list">
                                            ...
                                            <th class="bg-yellow-themed text-fixed-white " scope="col">Service Name
                                            </th>
                                            <th class="bg-yellow-themed text-fixed-white " scope="col">Service Logo
                                            </th>
                                            <th class="bg-yellow-themed text-fixed-white " scope="col">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody id="dataTable">
                                        @foreach($service as $index => $ser)
                                        <tr class="category-list">
                                            <td>{{ $index + 1 }}</td>
                                            <td class="data-name">{{ $ser->service_name }}</td>
                                            <td><img src="{{asset('/uploads/iconsservice/'.$ser->service_logo)}}"
                                                    alt=""> </td>
                                            <td>
                                                <a href="{{ route('editservice', $ser->id) }}"
...
<!-- AUTO COMPLETE JS -->
<script src="{{ asset('admin/libs/%40tarekraaser/autocomplete.js/autoComplete.min.js')}}"></script>
