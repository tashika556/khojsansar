        ...
        <div class="col-12">
            <form action="{{ route('businessspecialstore', $business->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="menu-topic-section special-info">
                                ...
                                <div class="row"> <input type="hidden" name="special_id[]" value="{{ $special->id }}">
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="special_name[]" class="form-control" value="{{ $special->special_name }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="short_detail[]" class="form-control" value="{{ $special->short_detail }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="price[]" class="form-control" value="{{ $special->price }}" required>
                                        </div>
                                    </div>

                                    <div class="col-md-2 col-12">
                                        <div class="form-group mt-4">
                                            <button type="button" class="btn btn-danger remove-special-item" data-id="{{ $special->id }}">
                    ...
                    @else
                        <p class="text-danger">You have already added 5 special items. You can edit them but cannot add more.</p>
                    @endif
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        let specialCount = {{ $specials->count() }};
        const maxSpecials = 5;
