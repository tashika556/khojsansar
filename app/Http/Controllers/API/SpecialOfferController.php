 ...
 class SpecialOfferController extends Controller
 {
     ...
     public function getAllSpecialOffers(Request $request)
     {
         ...
         if ($paginatedData->isEmpty()) {
             return response()->json(['success' => false, 'message' => 'No special offers found'], 404);
         }
     ...
     public function getOffersByRestaurant($restaurant_id)
     {
         ...
         if ($offersCollection->isEmpty()) {
             return response()->json(['success' => false, 'message' => 'No special offers found for this restaurant'], 404);
         }
 
         return response()->json([
             'success' => true,
             'data' => $offersCollection->values()
         ], 200);
     }
     ...
     public function getOffersByMunicipality($municipality_id)
     {
         ...
         if ($offersCollection->isEmpty()) {
             return response()->json(['success' => false, 'message' => 'No special offers found for this municipality'], 404);
         }
     ...
     public function getOffersByRestaurantAndMunicipality($restaurant_id, $municipality_id)
     {
         ...
         if ($offersCollection->isEmpty()) {
             return response()->json(['success' => false, 'message' => 'No special offers found for this restaurant and municipality'], 404);
         }
